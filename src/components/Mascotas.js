...
const [tiendas, setTiendas] = useState([]);
    ...
    useEffect(() => {
        return db.collection("tiendas").where("categoria", "==", "mascotas")
        .onSnapshot((snapshot)=>{
          const data = [];
        ...
        <div className={classes.heroContent}> <div className="cerrarsesion"> <button className= {classes.root} onClick={() => authentication.signOut()}>Cerrar sesión</button> </div>
          <Container maxWidth="sm">
            ...
            <Typography variant="h5" align="center" color="textSecondary" paragraph>
              ...
              Encuentra alimento balanceado, accesorios, servicios de corte y baño para tus mascotas, con precios super accesibles. 
            </Typography>
